  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const submissions = [
        ...
        {
          _id: getFieldId("email"),
          type: "email",
          text: "Таны и-мэйл хаяг",
          value: formData.email,
        },
        {
          _id: getFieldId("phone"),
          type: "phone",
          text: "Таны утасны дугаар",
          value: formData.phone,
        },
        {
          _id: getFieldId("text2"),
          type: "text",
          text: "Таны хүсэлт",
            ...
            <div className="grid gap-8 md:gap-10">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border-2 border-gray-200 px-4 py-3 text-gray-700 placeholder-gray-400 outline-none transition-all duration-200 focus:border-primary focus:ring-4 focus:ring-primary/10 hover:border-gray-300"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full resize-none rounded-xl border-2 border-gray-200 px-4 py-3 text-gray-700 placeholder-gray-400 outline-none transition-all duration-200 focus:border-primary focus:ring-4 focus:ring-primary/10 hover:border-gray-300"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 pt-4 border-t border-gray-200">
                <button
                  ...
                  disabled={loading}
                  className="w-full transform rounded-xl bg-primary from-primary to-primary py-4 px-8 text-lg font-semibold text-white shadow-xl transition-all duration-200 hover:scale-[1.02] hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="mx-auto w-full max-w-md rounded-3xl bg-white p-8 text-center shadow-2xl transform transition-all duration-300 scale-100">
              ...
              <button
                ...
                className="rounded-xl bg-primary px-8 py-3 font-semibold text-white shadow-lg hover:shadow-xl transition-all duration-200"
              >
                Дуусгах
              </button>
            </div>
